...
**Warning:** Most of the code that exists will be shown using primarily Verilog. There are some differences between the two that will be explained in the future. However, most of the code should work in both Verilog and System Verilog with minimal changes needed.
